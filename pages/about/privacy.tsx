  ...
  return (
    <div className='privacy-policy'>
      ...
      <p>
        ...
        protects and uses the personally identifiable information (&quot;Personal Information&quot;)
        you (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;) may provide through the
        predict.exchange website (predict.exchange) or in the course of purchasing any
        predict.exchange products (collectively, &quot;Website&quot;). The Policy also describes the
      ...
      <p>
        ...
        get investment insights. By connecting their financial accounts, users can view all of their
      ...
      <p>
        ...
        account information, and login credentials. This information is used to connect the
        user&apos;s financial accounts, provide personalized investment insights, and to communicate
      ...
      <ul>
        <li>
          Financial account information such as account balances, transactions, and investments.
        </li>
        <li>Demographic information such as age, income, and occupation.</li>
      ...
      <ul>
        ...
        <li>When users connect their financial accounts to our platform.</li>
        <li>
          When users provide information through forms on our website, such as contact forms or
          surveys.
        </li>
        <li>
      ...
      <ul>
        <li>Encryption of personal information during transmission and storage.</li>
        <li>
          Implementation of firewalls and other security technologies to prevent unauthorized
          access.
        </li>
        <li>
          Restrictions on access to personal information to only authorized employees and
          contractors.
        </li>
        <li>
      ...
      <p>
        Please be aware that despite our best efforts, no security measures are perfect or
        impenetrable. We cannot guarantee the security of personal information and will not be
      ...
      <ul>
        <li>Provide access to our dashboard and the insights it offers</li>
        <li>Provide customer support and troubleshoot issues</li>
        <li>Improve our website and services</li>
        <li>
          Communicate with you regarding updates, promotions, and other information related to our
          services
        </li>
      </ul>
      ...
      <ul>
        <li>
          Third-party service providers who assist us in providing our services, such as payment
          processors or data analytics providers
        </li>
      ...
      <p>
        ...
        information such as name, email address, financial account information, and login
      ...
      <p>
        ...
        the use of secure shredding of papers containing personal information, and the secure wiping
        of electronic media. We will also take steps to verify that the information has been
      ...
      <p>
        ...
        personal information from unauthorized access, use, alteration, or disclosure. These include
        but are not limited to:
      </p>
      <ul>
        <li>Encryption of sensitive personal information during transmission and storage</li>
        <li>Regular monitoring and testing of our security systems and procedures</li>
        <li>
          Restrictions on access to personal information to only authorized employees and
          contractors who need access to perform their job duties
        </li>
      </ul>
      <p>
        In addition, we require all third-party service providers with access to our user&apos;s
      ...
      <p>
        ...
        appropriate steps to investigate the breach, take measures to remediate the situation and
      ...
      <p>
        ...
        the purpose of linking your accounts to our platform. This information includes, but is not
      ...
      <p>
        ...
        third-party websites or services before providing them with any personal information.
        Additionally, we do not endorse, support, or guarantee the information, products, or
      ...
      <p>
        ...
        such changes, such as by prominently posting a notice of the changes on our website or
        sending an email notification to our users. We encourage you to review this Privacy Policy
      ...
      <p>
        ...
        accepted the changes. If you do not agree to the changes, you should discontinue your use of
      ...
      <p>Email: privacy@predict.exchange</p>
      <p>Phone: 281-330-8004</p>
      <p>
        We will make every effort to respond to your inquiry in a timely and professional manner.
      </p>
      <p>
        If you are not satisfied with our response, or if you believe that we have not adhered to
        this privacy policy, you may file a complaint with the relevant supervisory authority.
      </p>
    </div>
  );
};
